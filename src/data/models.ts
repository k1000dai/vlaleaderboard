...
export const MODELS: Record<string, ModelEntry> = {
    ...
    'act-camera-conditioned': {
        id: 'act-camera-conditioned',
        name: 'ACT (Camera Conditioned)',
        organization: 'TTIC, Waymo, Johns Hopkins University, TRI',
        paper: {
    ...
    'diffusion-policy-camera-conditioned': {
        id: 'diffusion-policy-camera-conditioned',
        name: 'Diffusion Policy (Camera Conditioned)',
        organization: 'TTIC, Waymo, Johns Hopkins University, TRI',
        paper: {
            title: 'Do You Know Where Your Camera Is? View-Invariant Policy Learning with Camera Conditioning',
            authors: ['Tianchong Jiang', 'Jingtian Ji', 'Xiangshan Tan', 'Jiading Fang', 'Anand Bhattad', 'Vitor Guizilini', 'Matthew R. Walter'],
    ...
    'smolvla-camera-conditioned': {
        id: 'smolvla-camera-conditioned',
        name: 'SmolVLA (Camera Conditioned)',
        organization: 'TTIC, Waymo, Johns Hopkins University, TRI',
        paper: {
            title: 'Do You Know Where Your Camera Is? View-Invariant Policy Learning with Camera Conditioning',
            authors: ['Tianchong Jiang', 'Jingtian Ji', 'Xiangshan Tan', 'Jiading Fang', 'Anand Bhattad', 'Vitor Guizilini', 'Matthew R. Walter'],
